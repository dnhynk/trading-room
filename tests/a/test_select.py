"""Invariants of the symbol selector (track_a/scan.py metrics and score, track_a/select.py basket verdicts).  python -m unittest tests.a.test_select"""
import math, time, unittest
from track_a.scan import two_way, trials, edge_of, flags_of, WIN, EDGE
from track_a import select
from track_a.select import plan, apply, flat_of, flats_now, record_dict, recent_engines, SELECT
...
class Evidence(unittest.TestCase):
    ...
    def test_live_edge_per_hour_from_the_window_of_completed_cycles(self):
        from track_a.select import evidence
    ...
    def test_contract_cuts_are_the_engine_made_changes_only(self):
        import os, tempfile
        from track_a.select import contract_cuts
    ...
    def test_the_leader_needs_two_measured_books_and_a_gap_outside_the_noise(self):
        from track_a.select import leader_of
    ...
    def test_more_books_than_slots_never_over_allocates_and_the_weakest_measured_leaves(self):
        from track_a.select import shares, verdict
    ...
    def test_shares_sum_to_the_pool_and_tilt_to_the_leader(self):
        from track_a.select import shares
...
class Verdict(unittest.TestCase):
    ...
    def test_a_main_book_negative_on_its_own_ledger_is_evicted_after_confirm_scans(self):
        from track_a.select import verdict
...
class Clusters(unittest.TestCase):
    def test_correlated_symbols_share_a_cluster_and_the_slow_flag_reads_trials_per_hour(self):
        from track_a.scan import clusters, corr
        import random
