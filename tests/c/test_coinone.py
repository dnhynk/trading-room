...
from track_c.execution.coinone import CoinoneError, CoinoneReadOnly, Credentials, NoRedirect, decimal, exchange
from track_c.ops.preflight import round_trip
...
class AuthenticationTests(unittest.TestCase):
    ...
    def test_write_endpoints_and_path_injection_are_rejected_before_transport(self):
        with patch("track_c.execution.coinone.exchange") as transport:
            client = CoinoneReadOnly(Credentials("test-access", "test-secret"), transport=transport)
