"""Fee-rebate sweep, run under the supervisor (python -m common.supervise sweep): every POLL seconds it reads the spot USDT balance and,
...
python -m common.sweep --once runs a single pass."""
