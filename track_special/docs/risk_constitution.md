...
For a pyramid candidate, risk independently recomputes the filled position's net exit
value from a conservative executable price, per-lot entry fees, booked funding cost,
future exit fees, and stressed future funding. A caller-supplied “profitable” boolean is
ignored and cannot authorize an add.
