...
post-crash deceleration and a candidate third detector.  python -m track_a.sweeps FILE... [--sym TRUMPUSDT] [--quiet] [--day YYYYMMDD]
...
from track_a.replay import lines
