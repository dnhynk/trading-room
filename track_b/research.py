...
python -m track_b.research --until "2026-09-05 12:00:00" --output logs/research-b-20260905.json
...
def main():
    ...
    ap.add_argument("--events", default=os.path.join(runtime_root(ROOT), "logs", "events.jsonl"))
    ap.add_argument("--scans", default=os.path.join(runtime_root(ROOT), "logs", "hunt-history.jsonl"))
