...
from track_c.ops.notices import DataUnavailable, REPLAY_VERSION, Replay, Source, TERMINAL, fact_payload, fill_payload, krw, number, payload, qty
...
def operating_fields(state, status):
    ...
    from track_c.execution.accounting import residual_value
